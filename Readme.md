...
| `LIBRARY_ACTIVE_WINDOW`             | 168h                  | How far back a read counts towards the active library, which is the working set a cache would have to hold to serve those reads without fetching the same bytes twice                                                                                                                                                                                                    |
| **Metadata**                        |
