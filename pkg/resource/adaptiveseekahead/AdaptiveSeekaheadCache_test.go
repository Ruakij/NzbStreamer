package adaptiveseekahead_test
...
func TestAdaptiveSeekaheadCacheRead(t *testing.T) {
	t.Parallel()

	res := bytesresource.BytesResource{Content: []byte("Hello, World!")}
	arc := adaptiveseekahead.NewAdaptiveSeekahead(&res, time.Second, time.Second*2, 5, 20, 10)
	...
	// Testing the seekahead by reading more
	n, err = reader.Read(buf)
	if err != nil && !errors.Is(err, io.EOF) {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestAdaptiveSeekaheadCacheSeek(t *testing.T) {
	t.Parallel()
...
func TestAdaptiveSeekaheadCacheMultipleSeeks(t *testing.T) {
	t.Parallel()
...
func TestAdaptiveSeekaheadCacheEOF(t *testing.T) {
	t.Parallel()
...
func TestAdaptiveSeekaheadCacheMultipleReads(t *testing.T) {
	t.Parallel()
...
func TestAdaptiveSeekaheadCacheSequentialReadWriteSeek(t *testing.T) {
	t.Parallel()
